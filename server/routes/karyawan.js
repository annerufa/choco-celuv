...
const { getAllKaryawan, createKaryawan, myProfile, updateKaryawan, statusKaryawan, getKurir, getPenjaga, getAllKaryawanwithJadwal, updatePassword } = require('../controllers/karyawanController');
