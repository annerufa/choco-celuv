...
import AbsensiHariIni from '../../components/Absensi/AbsensiHariIni';
import AbsensiRekap from '../../components/Absensi/AbsensiRekap';
import styles from './RekapAbsensi.module.css';
    ...
    return (
        <div className={styles.page}>
            ...
            <div className={styles.pageHeader}>
                ...
                <h1 className={styles.pageTitle}>Absensi</h1>
                <p className={styles.pageSubtitle}>Kelola absensi dan rekap</p>
            </div>

            <div style={{ backgroundColor: '#fff', border: '1px solid var(--brown-100)', borderRadius: 10, }}>
                {/* Tab Bar */}
                <div style={{
                    display: 'flex',
                    gap: 4,
